...
const Partner = () => {
    ...
    let leftSidePar = 'Получайте заказы от клиентов, привозите товар и получайте большe прибыли от онлайн продаж'
   let style = {
    display: 'flex',
    alignItems: 'center',
    ...
    return (
        <StyledLanding>
            ...
            <Text
                ...
                text={'С помощью продвижения ставками вы можете показывать товары бренда и предложения магазинов-партнёров на более выгодных позициях в результатах поиска, товарной карточке и на страницах категорий'}
            />
            <Text
                heading={'Продвигайте товары'}
                text={'С помощью продвижения ставками вы можете показывать товары бренда и предложения магазинов-партнёров на более выгодных позициях в результатах поиска, товарной карточке и на страницах категорий'}
