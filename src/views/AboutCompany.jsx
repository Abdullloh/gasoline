      ...
      <StyledContainer>
        <div className="container">
          ...
          <p className="text">
            ...
            где вы можете легко размещать свои товары и управлять ими. С нами вы
            можете легко надохить покупателей в онлайн! Продвигайте свои товары
            вместе с нами <br/> Вам всего лишь нужно зарегистрироваться в партнерской
            программе, заполните необходимые формы и наши менеджеры свяжутся с
            вами в ближайшее время. После получения доступа к партнерский
            кабинет вы можете добавлять свои товары на нашей площадке и
            мониторинг будет максимально удобно. <br/> Интернет-магазины сейчас быстро
            развиваются и мы создаем удобства для производителей и покупателей.
            Размещаяя свои товары на нашей площадке вы делаете жизнь покупателей
            легче и лучше, с нами мы можете увеличить свои продажи. <br/> Мы помогаем
            производителям быстро и без лишниз затрат выходить на онлайн рынок,
            вам не нужно создавать веб-сайт, тратиться на продвижение своего
            сайта колосальные деньги, мы сделаем это за вас.<br/> Основными задачами
            Портала являются:<br/> предоставление возможности реализации и
            приобретения готовой продукции, комплектующих изделий, сырья и
            материалов, производимых отечественными промышленными предприятиями
            через оналйн площадки внедрение механизма обеспечения свободы
            отношений и прозрачности заключения договоров и платежей между
            ...
            производителями и покупателями. <br/> Портал выполняет следующие функции:
            <br/>
